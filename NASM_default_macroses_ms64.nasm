...
;DEFINING ARGUMENTS LOCATION FOR CURRENT POINTER SIZE
        ...
        %define STACK_ARG7_SP [STACK_ARGX_ESP(3)]
            %define STACK_ARG7_SP8 byte[STACK_ARGX_ESP(3)]
            %define STACK_ARG7_SP16 word[STACK_ARGX_ESP(3)]
            %define STACK_ARG7_SP32 dword[STACK_ARGX_ESP(3)]
        ...
        %define STACK_ARG7_BP [STACK_ARGX_ESP(3)]
            %define STACK_ARG7_BP8 byte[STACK_ARGX_ESP(3)]
            %define STACK_ARG7_BP16 word[STACK_ARGX_ESP(3)]
            %define STACK_ARG7_BP32 dword[STACK_ARGX_ESP(3)]
...
%macro NASM_DEFAULT_MACROSES_INTERNAL_MACRO_DEFINE_INT_STACK_ARGUMENT_SP8 2-3
	%if %2<=4
        ...
        %elif %2=4
            %define %[%1] r9b
        %else
            %error DID YOU GAVE STACK argument index 0 ?
        %endif
    %else
        %define %[%1] byte[STACK_ARGX_ESP((%2)-4)]
    %endif
%endmacro
%macro NASM_DEFAULT_MACROSES_INTERNAL_MACRO_DEFINE_INT_STACK_ARGUMENT_SP16 2-3
	%if %2<=4
        ...
        %endif
    %else
        %define %[%1] word[STACK_ARGX_ESP((%2)-4)]
    %endif
%endmacro
%macro NASM_DEFAULT_MACROSES_INTERNAL_MACRO_DEFINE_INT_STACK_ARGUMENT_SP32 2-3
	%if %2<=4
        ...
        %endif
    %else
        %define %[%1] dword[STACK_ARGX_ESP((%2)-4)]
    %endif
%endmacro
...
%macro NASM_DEFAULT_MACROSES_INTERNAL_MACRO_DEFINE_INT_STACK_ARGUMENT_BP8 2-3
	%if %2<=4
        ...
        %endif
    %else
        %define %[%1] byte[STACK_ARGX_EBP((%2)-4)]
    %endif
%endmacro
%macro NASM_DEFAULT_MACROSES_INTERNAL_MACRO_DEFINE_INT_STACK_ARGUMENT_BP16 2-3
	%if %2<=4
        ...
        %endif
    %else
        %define %[%1] word[STACK_ARGX_EBP((%2)-4)]
    %endif
%endmacro
%macro NASM_DEFAULT_MACROSES_INTERNAL_MACRO_DEFINE_INT_STACK_ARGUMENT_BP32 2-3
	%if %2<=4
        ...
        %endif
    %else
        %define %[%1] dword[STACK_ARGX_EBP((%2)-4)]
    %endif
%endmacro
